    ...
    <main className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-blue-100 p-8">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-lg p-8 text-center">
        ...
        <button
          ...
          disabled={carregando}
          className="w-full flex items-center justify-center gap-3 border border-gray-300 rounded-lg py-3 px-6 bg-white hover:bg-gray-50 text-gray-800 font-medium transition-colors disabled:opacity-50"
        >
